...
-- Schema ipp_chat
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ipp_chat` DEFAULT CHARACTER SET utf8 ;
USE `ipp_chat` ;

-- -----------------------------------------------------
-- Table `ipp_chat`.`ciudad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`ciudad` (
...
-- -----------------------------------------------------
-- Table `ipp_chat`.`sesion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`sesion` (
...
-- -----------------------------------------------------
-- Table `ipp_chat`.`codigo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`codigo` (
...
-- -----------------------------------------------------
-- Table `ipp_chat`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`usuario` (
  ...
  INDEX `fk_usuario_sesion1_idx` (`token` ASC),
  INDEX `fk_usuario_codigo1_idx` (`codigo` ASC),
  CONSTRAINT `fk_usuario_ciudad1`
    FOREIGN KEY (`id_ciudad`)
    REFERENCES `ipp_chat`.`ciudad` (`id_ciudad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_sesion1`
    FOREIGN KEY (`token`)
    REFERENCES `ipp_chat`.`sesion` (`token`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_codigo1`
    FOREIGN KEY (`codigo`)
    REFERENCES `ipp_chat`.`codigo` (`codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ipp_chat`.`mensaje`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`mensaje` (
...
-- Table `ipp_chat`.`chat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`chat` (
  `id_chat` INT NOT NULL AUTO_INCREMENT,
  `cantidad_personas` INT NOT NULL,
  `id_mensaje` INT NOT NULL,
  PRIMARY KEY (`id_chat`),
  INDEX `fk_chat_mensaje_idx` (`id_mensaje` ASC),
  CONSTRAINT `fk_chat_mensaje`
    FOREIGN KEY (`id_mensaje`)
    REFERENCES `ipp_chat`.`mensaje` (`id_mensaje`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ipp_chat`.`chat_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`chat_usuario` (
  `usuario_id_usuario` INT NOT NULL,
  `usuario_id_ciudad` INT NOT NULL,
  `chat_id_chat` INT NOT NULL,
  INDEX `fk_chat_usuario_usuario2_idx` (`usuario_id_usuario` ASC, `usuario_id_ciudad` ASC),
  INDEX `fk_chat_usuario_chat2_idx` (`chat_id_chat` ASC),
  CONSTRAINT `fk_chat_usuario_usuario2`
    FOREIGN KEY (`usuario_id_usuario` , `usuario_id_ciudad`)
    REFERENCES `ipp_chat`.`usuario` (`id_usuario` , `id_ciudad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_chat_usuario_chat2`
    FOREIGN KEY (`chat_id_chat`)
    REFERENCES `ipp_chat`.`chat` (`id_chat`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ipp_chat`.`mensaje_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ipp_chat`.`mensaje_usuario` (
  `id_mensaje` INT NOT NULL,
  `id_usuario` INT NOT NULL,
  INDEX `fk_mensaje_usuario_usuario_idx` (`id_usuario` ASC),
  INDEX `fk_mensaje_usuario_mensaje_idx` (`id_mensaje` ASC),
  CONSTRAINT `fk_mensaje_usuario_usuario`
    FOREIGN KEY (`id_usuario`)
    REFERENCES `ipp_chat`.`usuario` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_mensaje_usuario_mensaje`
    FOREIGN KEY (`id_mensaje`)
    REFERENCES `ipp_chat`.`mensaje` (`id_mensaje`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
INSERT INTO `codigo` (`codigo`, `disponibilidad`) VALUES ('1234567', '1'), ('2345678', '1');
INSERT INTO `codigo` (`codigo`, `disponibilidad`, `email_usuario`) VALUES ('3456789', '1', NULL);
