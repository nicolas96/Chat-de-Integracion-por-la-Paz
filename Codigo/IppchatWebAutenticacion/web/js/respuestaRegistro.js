...
function desplegarCiudades(){
    ...
    xmlhttp.open("POST","http://imac-de-maurico:8080/IppchatServiciosAutenticacion/webresources/ciudad/listar",true);
...
function consumirRegistro(nombre,apellido,ciudad,correo,contrasena,codigo){
    var xmlhttp=new  XMLHttpRequest();
    xmlhttp.open("POST","http://imac-de-maurico:8080/IppchatServiciosAutenticacion/webresources/usuario/registro?codigo="+codigo+
